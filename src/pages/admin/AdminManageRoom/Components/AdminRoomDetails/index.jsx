...
function AdminRoomDetails() {
    const { roomId } = useParams();
    const { data, isLoading } = roomApi.useGetRoomDetailQuery(roomId);
    ...
    return (
        <div className="admin-room-details-wrapper">
            <div className="card">
                <Spin spinning={isLoading}>
                    ...
                    <div className="details">
                        ...
                        <div className="item-50">
                            <label>Price</label>
                            <p className="input">{data?.data?.room_price?.toLocaleString()}</p>
                        </div>
                        <div className="item-50">
